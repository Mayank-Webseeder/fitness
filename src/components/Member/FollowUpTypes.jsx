...
import { SquareUser, Search, Plus, Trash2, Edit2 } from "lucide-react";
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              <tr className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-2 text-sm text-gray-700">Irregular members</td>
              ...
              <tr className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-2 text-sm text-gray-700">Trial sessions</td>
                <td className="px-4 py-2 flex gap-2">
                  <button className="text-gray-500 hover:text-blue-600">
                    <Edit2 className="w-4 h-4" />
                  </button>
